#!/usr/bin/ruby -w
#
# $Id: tc_amazon-manufacturer_search.rb,v 1.1 2004/02/29 10:34:25 ianmacd Exp $
...
class TC_AmazonHTTPTest
  ...
  def test_manufacturer_search
    [Search::HEAVY, Search::LITE].each do |heaviness|
      ...
      resp = @@req.manufacturer_search('red hat', 'software', heaviness)
      assert_kind_of(Amazon::Search::Response, resp,
	  'could not perform an Amazon::Search::Request#manufacturer_search')
      prods = resp.products
