/**
 * @file x86.h
 * @desc routines to let C code use special x86 instructions
 */
#ifndef X86_H
#define X86_H
...
static __inline uint8_t inb(int) __attribute__((always_inline));
static __inline void insb(int, void *, int) __attribute__((always_inline));
static __inline uint16_t inw(int) __attribute__((always_inline));
static __inline void insw(int, void *, int) __attribute__((always_inline));
static __inline uint32_t inl(int) __attribute__((always_inline));
static __inline void insl(int, void *, int) __attribute__((always_inline));
static __inline void outb(int, uint8_t) __attribute__((always_inline));
static __inline void outsb(int, const void *, int) __attribute__((always_inline));
static __inline void outw(int, uint16_t) __attribute__((always_inline));
static __inline void outsw(int, const void *, int) __attribute__((always_inline));
static __inline void outsl(int, const void *, int) __attribute__((always_inline));
static __inline void outl(int, uint32_t) __attribute__((always_inline));
static __inline void invlpg(void *) __attribute__((always_inline));
static __inline void lidt(void *) __attribute__((always_inline));
static __inline void lldt(uint16_t) __attribute__((always_inline));
static __inline void ltr(uint16_t) __attribute__((always_inline));
static __inline void lcr0(uint32_t) __attribute__((always_inline));
...
static __inline void lcr3(uint32_t) __attribute__((always_inline));
static __inline uint32_t rcr3(void) __attribute__((always_inline));
static __inline void lcr4(uint32_t) __attribute__((always_inline));
...
static __inline void write_eflags(uint32_t) __attribute__((always_inline));
static __inline uint32_t read_ebp(void) __attribute__((always_inline));
static __inline uint32_t read_esp(void) __attribute__((always_inline));
static __inline void cpuid(uint32_t, uint32_t *, uint32_t *, uint32_t *, 
                           uint32_t *);
