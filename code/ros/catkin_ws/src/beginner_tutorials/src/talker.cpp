...
// convenience header which includes all headers
#include "ros/ros.h"

// std_msgs package
// -- header generated automatically from String.msg file in the std_msgs pkg
...
int main(int argc, char **argv)
{
  ...
  // initialize ROS
  // NODE name must be unqiue in a running system
  ros::init(argc, argv, "talker" /*name of rosnode*/);
  ...
  // -- constructor will initialize this node
  ros::NodeHandle n;
   ...
   */
  // tell the master that we will publish a message 
  // -- of type std_msgs::String
  // -- of name "chatter"
  // -- publish queue of size 1000 (if consumer is slow, up to 1000 queued)

  // Publisher object's purpose
  // -- 1) contains publish() method through which you publish messages
  // -- 2) when it goes out of scope, it will automatically unadvertise
  //       -- stack-based deletion
  ros::Publisher chatter_pub = n.advertise<std_msgs::String>("chatter", 1000);

  // frequency that you'd want to look at
  // -- 10hz (10 times a sec)
