 ...
 * 2012-12-31T20:05:54.342-08:00
 * Generated source version: 2.6.3
 * 
 */
@WebServiceClient(name = "OrderEndpointService", 
                  wsdlLocation = "file:/home/cjeong/ztmp/code/camel/camelinaction-source/chapter9/riderautoparts-order/src/main/resources/wsdl/order.wsdl",
...
public class OrderEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/cjeong/ztmp/code/camel/camelinaction-source/chapter9/riderautoparts-order/src/main/resources/wsdl/order.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(OrderEndpointService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/cjeong/ztmp/code/camel/camelinaction-source/chapter9/riderautoparts-order/src/main/resources/wsdl/order.wsdl");
        }
        WSDL_LOCATION = url;
    }
