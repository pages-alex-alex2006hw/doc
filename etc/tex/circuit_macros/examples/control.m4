...
S1: circle
  ...
  box "$G(s)$"
  arrow right ; "$y(s)$" above rjust at Here+(0,2/72.27)
  line down boxht*3/2 from last arrow.c then left last arrow.c.x-S1.x
  arrow to S1.s
  "$-\;$" below rjust
  ]
  "(a) $PID$ control" below ljust at last [].sw+(0,-5/72.27)
...
Plant: box wid boxwid*3/2 ht boxht*5/4 \
  ...
  "$y$" above rjust at Here+(0,2/72.27)
...
UR:(D.e,UL) + (0.1,0)
  ...
  "(c) Nonlinear feedforward (for performance) and small-signal feedback
   (for stability)" below ljust at last [].sw+(0,-5/72.27)
.PE
